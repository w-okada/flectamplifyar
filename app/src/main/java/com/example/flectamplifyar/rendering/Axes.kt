...
object Axes {
    ...
    fun draw(r: Float, g: Float, b: Float, a: Float, shininess: Float, linewidth: Float) {
        ...
        GLES20.glDrawElements(GLES20.GL_LINE_STRIP, 14, GLES20.GL_UNSIGNED_BYTE, indexBuffer)

        //P14から5個の連続点で，文字Xを描く
        indexBuffer!!.position(14)
        GLES20.glDrawElements(GLES20.GL_LINE_STRIP, 5, GLES20.GL_UNSIGNED_BYTE, indexBuffer)
        ...
        GLES20.glDrawElements(GLES20.GL_LINE_STRIP, 4, GLES20.GL_UNSIGNED_BYTE, indexBuffer)
